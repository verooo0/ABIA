...
class AzamonParameters(object):
    def __init__(self, max_weight: int, package_weights: List[float], priority_packages: List[int], max_delivery_days_per_package: List[int],offer_capacities: List[float], days_limits: List[int], price_kg: List[float]):
        ...
        self.max_delivery_days_per_package = max_delivery_days_per_package #Max days to deliver a package
