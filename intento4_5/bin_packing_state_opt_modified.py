...
class StateRepresentation(object):
    ...
    def heuristic_combined(self) -> float:
        # Combining cost and happiness with a weighted approach, where we give equal weight to cost and happiness
        cost_weight = 0.5
        happiness_weight = 0.5
        return (cost_weight * (-self.heuristic_cost())) + (happiness_weight * self.heuristic_happiness())
